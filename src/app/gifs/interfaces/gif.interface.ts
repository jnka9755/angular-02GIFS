...
export class Convert {
    public static toGIFModel(json: string): GIFModel {
        return cast(JSON.parse(json), r("GIFModel"));
    }

    public static gIFModelToJson(value: GIFModel): string {
        return JSON.stringify(uncast(value, r("GIFModel")), null, 2);
    }
}
